...
<style>
    ...
    .memory-card:hover { transform: translateX(2px); }
    ...
    .status-active { background-color: #10b981; box-shadow: 0 0 0 2px rgba(16, 185, 129, 0.2); animation: pulse 2s infinite; }
    ...
    div[data-testid="stChatInput"]:focus-within {
        ...
        box-shadow: 0 0 0 3px rgba(139, 92, 246, 0.1), 0 4px 12px rgba(0, 0, 0, 0.05) !important;
    }
    
    /* Remove Internal Double Border & Background */
    ...
    /* ================= Force Sidebar (Legacy Support) ================= */
    /* Keeping the structural rules to ensure sidebar stays open as per original logic */
...
def render_chat():
    ...
    if not messages:
        ...
        <div class="empty-state">
            ...
            <div class="empty-title">{t('main_title')}</div>
            <div class="empty-desc">{t('memory_tip')}</div>
        </div>
        """, unsafe_allow_html=True)
